...
public class Display4Activity extends DisplayActivity implements GestureDetector.OnGestureListener {
    ...
    public final static String DISPLAY_NUMBER = "D4"; //NON-NLS
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("onCreate panel 4"); //NON-NLS
    ...
    */
    ...
    private void initRueckwaertsButton() {
        ...
        rueckwaertsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Display4Activity.this, Display3Activity.class);
    ...
    private void initCustomScrollView() {
        CustomScrollView customScrollView = (CustomScrollView)findViewById(R.id.customscrollviewD4);
    ...
    public void initResultTable() {
        ...
        LinearLayout resultTable = (LinearLayout) findViewById(R.id.resultTableD4);

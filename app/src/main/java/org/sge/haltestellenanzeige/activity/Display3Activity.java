...
public class Display3Activity extends DisplayActivity implements GestureDetector.OnGestureListener {
    public final static String DISPLAY_NUMBER = "D3"; //NON-NLS
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("onCreate panel 3"); //NON-NLS
    ...
    private void initRueckwaertsButton() {
        ...
        rueckwaertsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Display3Activity.this, Display2Activity.class);
    ...
    private void initCustomScrollView() {
        CustomScrollView customScrollView = (CustomScrollView)findViewById(R.id.customscrollviewD3);
    ...
    public void initResultTable() {
        ...
        LinearLayout resultTable = (LinearLayout) findViewById(R.id.resultTableD3);
